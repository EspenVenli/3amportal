...
import { Upload, X, RefreshCw, Download, Play, Image as ImageIcon, Tag } from 'lucide-react';
...
const Digitalization: React.FC = () => {
    ...
    if (draggingId && targetId) {
      ...
      if (draggedImage?.type === 'label' && targetImage?.type === 'exhibit') {
        setMatchedPairs(prev => [
          ...prev.filter(pair => pair.exhibitId !== targetId && pair.labelId !== draggingId),
  ...
  const toggleImageType = (id: string) => {
    ...
    // Remove any existing matches involving this image
